                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            @if(Auth::user()->is_admin)
                                ...
                                <div class="px-1 py-1 text-xs font-semibold text-gray-400 uppercase tracking-wider">
                                    Admin functies
                                </div>
                                ...
                                <x-dropdown-link :href="route('admin.contact.index')" class="text-gray-100 hover:bg-slate-700">
                                ...
                                <x-dropdown-link :href="route('admin.news.create')" class="text-gray-100 hover:bg-slate-700">
                                    <div class="flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="pt-4 pb-1 border-t border-slate-600">
                ...
                <div class="mt-3 space-y-1">
                    ...
                    @if(Auth::user()->is_admin)
                        ...
                        <x-responsive-nav-link :href="route('admin.contact.index')" class="text-gray-200 hover:text-purple-300 hover:bg-slate-700">
                        ...
                        <x-responsive-nav-link :href="route('admin.news.create')" class="text-gray-200 hover:text-purple-300 hover:bg-slate-700">
                            {{ __('Nieuws toevoegen') }}
                        </x-responsive-nav-link>
                    @endif
