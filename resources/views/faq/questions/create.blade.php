                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('faq.questions.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="question" id="question" value="{{ old('question') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                            @error('question')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="answer" id="answer" rows="5" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>{{ old('answer') }}</textarea>
                            @error('answer')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
